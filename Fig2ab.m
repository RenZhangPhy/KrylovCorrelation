...
dataC1 = load('Correlation_Ozx_site=13_O_loc=6_h=1_g=0.txt');
databn1 = load('bn_Ozx_site=13_O_loc=6_h=1_g=0.txt');

dataC2 = load('Correlation_Oyy_site=13_O_loc=6_h=1_g=1.txt');
databn2 = load('bn_Oyy_site=13_O_loc=6_h=1_g=1.txt');
...
leg = legend([num2str(mean(derbn1),'%.3f'),'$\pm$',num2str(std(derbn1)/sqrt(num(2)),'%.3f'),'$,\sigma_0^z\sigma_1^x$'],...
...
data = load('Correlation_Ozx_site=13_O_loc=6_h=1_g=0.txt');
plot(data(:,1),data(:,2),'MarkerSize',10,'Marker','o','LineWidth',1,'LineStyle','-','Color','r')

data = load('Corr_Expolate_Oyy_h=1_g=1.txt');
plot(data(:,1),data(:,2),'MarkerSize',10,'Marker','s','LineWidth',1,'LineStyle','-','Color','b')


set(gca,'FontSize',40,'LineWidth',2,'xlim',[0,2])
